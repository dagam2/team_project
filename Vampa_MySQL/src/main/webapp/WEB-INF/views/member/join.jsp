...
<div class="wrapper">
	...
	<div class="wrap">
			...
			<div class="user_wrap">
				...
				<div class="user_input_box"><input class="user_input" name="memberName"></div>
...
$(document).ready(function(){
    ...
    $(".join_button").click(function(){
        ...
        /* 성별 유효성 검사 */
        if(sex == ""){
            $('.final_sex_ck').css('display','block');
            sexCheck = false;
        }else{
        ...
        if(idCheck&&idckCheck&&pwCheck&&pwckCheck&&pwckcorCheck&&
        		nameCheck&&sexCheck&&phoneNumCheck&&birthCheck&&mailCheck&&mailnumCheck&&addressCheck ){
